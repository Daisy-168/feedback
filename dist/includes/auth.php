...
if(isset($_POST['register'])){
    ...
    if(empty($username)){
        ...
        if(isUserExists($email)){
            ...
            $sql = "INSERT INTO users(username,email,phone,password,role_id) VALUES('$username','$email','$phone','$hashed_password',$role_id)";
...
if(isset($_POST['login'])){
    ...
    if(empty($email)){
        ...
        if(!isUserExists($email)){
            ...
            $fetch_user = "SELECT u.* , r.name as role
                FROM users u
           ...
           if (!password_verify($password, $user['password'])) {
            header(header: 'location: ../../index.php?error=Incorrect Password!');
                ...
                $location = ($_SESSION['role'] == 'admin' ? '../pages/index.php' : '../pages/client/index.php');
